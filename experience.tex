...
{{\color{facebookblue}Facebook} --- Privacy Infrastructure} % Organization
...
{{\color{facebookblue}Facebook} --- Ads Signals} % Organization
{Menlo Park, CA} % Location
{Summer 2016} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
...
\cventry
{Software Engineering Intern} % Job title
{{\color{facebookblue}Facebook} --- Ads Infrastructure} % Organization
{Menlo Park, CA} % Location
{Fall 2015} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
