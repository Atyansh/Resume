...
{\raisebox{-0.04cm}{\includegraphics[height=0.30cm]{anthropic}} --- Privacy Infrastructure} % Organization
{San Francisco, CA} % Location
{September 2025 --- Present} % Date(s)
{% Description(s) of tasks/responsibilities
  \begin{cvitems}
    \item {Building Privacy Aware Infrastructure at layers in the tech stack with a key focus on Data Governance}
    \item {Strongly leveraging AI tooling, such as \textbf{claude code}, as a full fledged development paradigm}
    \item {Technologies include \textbf{Python}, \textbf{React}, \textbf{AlloyDB}, \textbf{BigQuery}, \textbf{GCP}}
    \item {Building privacy preserving systems for model training, ensuring regulatory compliance with \textbf{HIPAA}, \textbf{GDPR}, etc.}
  \end{cvitems}
}
...
{March 2024 --- September 2025} % Date(s)
{% Description(s) of tasks/responsibilities
  \begin{cvitems}
