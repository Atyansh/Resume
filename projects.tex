...
{Saber: Delegating Web Security to Browser---\color{blue}{\href{https://atyansh.com/saber.pdf}{\textbf{(Paper)}}}} % Organization/group
{} % Location
{} % Date(s)
...
{Multiplayer Brawler---\color{blue}{\href{https://www.youtube.com/watch?v=hPvb\_gEyWpQ}{\textbf{(Video Game)}}}} % Organization/group
{} % Location
{} % Date(s)
{ % Description(s) of experience/contributions/knowledge
\begin{cvitems}
